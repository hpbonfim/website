        ...
        <div className="card" style={style}>
          ...
          <div className="card-list">
            <header className="card-header">
              <img className="card-header-image" src={"https://raw.githubusercontent.com/hpbonfim/website/production/src/assets/projetos-page/projects800x600.jpg"} alt={"projects"} />
            </header>
            <div className="card-footer">
